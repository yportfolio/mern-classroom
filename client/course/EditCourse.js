...
const EditCourse = ({ match }) => {
  ...
  /**
   *
   * @param {*} name the property name of the course state
   * @param {*} index it's index in lessons array
   ...
   *
   * @param {*} index
   * Switch target lesson's place with the lesson above it.
   */
    ...
    <div className={classes.root}>
      <Card className={classes.card}>
        ...
        <div className={classes.details}>
          ...
          {/* image is taken by url, the image filed in state is only for uploading image  */}
